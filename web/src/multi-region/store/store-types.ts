...
export interface UserPreferences {
  ...
  // Table state — keyed by tableId (Contract §5)
...
export const DEFAULT_THROTTLE_STATS: ThrottleStats = {
  perSubscription: {},
  history: [],
};

// --- History (rolling time-series for sparklines + cluster health) ---
