...
export function resolveToken(name: ColorTokenName, alpha = 1): string {
 ...
 */
export const DENSITY_CLASSES = ["density-compact", "density-comfortable"] as const;
 ...
 */
export const TONES = ["primary", "info", "success", "warning", "destructive"] as const;
