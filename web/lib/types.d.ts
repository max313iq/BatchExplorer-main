...
declare module "@azure/bonito-core" {
    interface LocalizedStrings extends BonitoUiResourceStrings, ServiceResourceStrings, ReactResourceStrings, PlaygroundResourceStrings, GeneratedResourceStrings {
    }
}
