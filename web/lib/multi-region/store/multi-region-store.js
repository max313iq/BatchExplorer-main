 ...
 */
import { createInitialState, DEFAULT_AGENT_STATUSES, DEFAULT_USER_PREFERENCES, generateSessionId, MAX_HISTORY_SNAPSHOTS, } from "./store-types";
import { setActiveTenant as msalSetActiveTenant } from "../auth/msal-auth";
import { loadPoolDefaults, savePoolDefaults, resetPoolDefaults as resetPoolDefaultsStorage, } from "./pool-defaults";
...
export class MultiRegionStore {
    constructor(initialState) {
        ...
        Object.defineProperty(this, "_auditListeners", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        });
        Object.defineProperty(this, "_pausedActivities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        ...
        Object.defineProperty(this, "authMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: "msal"
        });
        this._state = Object.assign(Object.assign({}, createInitialState()), initialState);
    ...
    setSubscriptions(subscriptions) {
        this._state = Object.assign(Object.assign({}, this._state), { subscriptions: [...subscriptions] });
        this._notify();
    }
    // --- Accounts ---
    addAccount(account) {
        this._state = Object.assign(Object.assign({}, this._state), { accounts: [...this._state.accounts, account] });
        this._notify();
    }
    updateAccount(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { accounts: this._state.accounts.map((a) => a.id === id ? Object.assign(Object.assign({}, a), patch) : a) });
        this._notify();
    }
    removeAccount(id) {
        this._state = Object.assign(Object.assign({}, this._state), { accounts: this._state.accounts.filter((a) => a.id !== id) });
        this._notify();
    }
    // --- Pools ---
    addPool(pool) {
        this._state = Object.assign(Object.assign({}, this._state), { pools: [...this._state.pools, pool] });
        this._notify();
    }
    updatePool(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { pools: this._state.pools.map((p) => p.id === id ? Object.assign(Object.assign({}, p), patch) : p) });
        this._notify();
    }
    // --- Nodes ---
    setNodes(nodes) {
        this._state = Object.assign(Object.assign({}, this._state), { nodes: [...nodes] });
        this._notify();
    }
    updateNode(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { nodes: this._state.nodes.map((n) => n.id === id ? Object.assign(Object.assign({}, n), patch) : n) });
        this._notify();
    }
    removeNode(id) {
        this._state = Object.assign(Object.assign({}, this._state), { nodes: this._state.nodes.filter((n) => n.id !== id) });
        this._notify();
    }
    // --- Pool Infos ---
    setPoolInfos(pools) {
        this._state = Object.assign(Object.assign({}, this._state), { poolInfos: [...pools] });
        this._notify();
    }
    updatePoolInfo(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { poolInfos: this._state.poolInfos.map((p) => p.id === id ? Object.assign(Object.assign({}, p), patch) : p) });
        this._notify();
    }
    // --- Account Infos ---
    setAccountInfos(accounts) {
        this._state = Object.assign(Object.assign({}, this._state), { accountInfos: [...accounts] });
        this._notify();
    }
    updateAccountInfo(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { accountInfos: this._state.accountInfos.map((a) => a.id === id ? Object.assign(Object.assign({}, a), patch) : a) });
        this._notify();
    }
    // --- Agent Statuses ---
    setAgentStatus(agent, status) {
        this._state = Object.assign(Object.assign({}, this._state), { agentStatuses: Object.assign(Object.assign({}, this._state.agentStatuses), { [agent]: status }) });
        this._notify();
    }
    // --- Agent Logs ---
    addLog(entry) {
        const log = Object.assign(Object.assign({}, entry), { timestamp: new Date().toISOString() });
        this._state = Object.assign(Object.assign({}, this._state), { agentLogs: [...this._state.agentLogs, log] });
        this._notify();
    }
    clearLogs() {
        this._state = Object.assign(Object.assign({}, this._state), { agentLogs: [] });
        this._notify();
    }
    // --- Audit Entries ---
    /**
    ...
    addAuditEntry(entry) {
        ...
        this._state = Object.assign(Object.assign({}, this._state), { auditEntries });
        this._notify();
        this._notifyAudit();
    }
    ...
    setGlobalFilter(filter) {
        this._state = Object.assign(Object.assign({}, this._state), { globalFilter: Object.assign(Object.assign({}, this._state.globalFilter), filter) });
        this._notify();
    }
    // --- Notifications ---
    addNotification(entry) {
        const notification = Object.assign(Object.assign({}, entry), { id: Math.random().toString(36).substring(2, 10), timestamp: new Date().toISOString() });
        const notifications = [...this._state.notifications, notification];
        // Keep last 50
        this._state = Object.assign(Object.assign({}, this._state), { notifications: notifications.slice(-50) });
        this._notify();
    }
    removeNotification(id) {
        this._state = Object.assign(Object.assign({}, this._state), { notifications: this._state.notifications.filter((n) => n.id !== id) });
        this._notify();
    }
    // --- Activities ---
    addActivity(activity) {
        ...
        const newActivity = Object.assign(Object.assign({}, activity), { id, startedAt: new Date().toISOString() });
        const activities = [...this._state.activities, newActivity];
        this._state = Object.assign(Object.assign({}, this._state), { activities: activities.slice(-200) });
        this._notify();
        this._schedulePersistActivities();
        return id;
    }
    addChildActivity(parentId, activity) {
        const id = Math.random().toString(36).substring(2, 10) +
            Math.random().toString(36).substring(2, 10);
        const child = Object.assign(Object.assign({}, activity), { id,
            parentId, startedAt: new Date().toISOString() });
        const activities = this._state.activities.map((a) => { var _a; return a.id === parentId ? Object.assign(Object.assign({}, a), { children: [...((_a = a.children) !== null && _a !== void 0 ? _a : []), id] }) : a; });
    ...
    updateActivity(id, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { activities: this._state.activities.map((a) => a.id === id ? Object.assign(Object.assign({}, a), patch) : a) });
        this._notify();
        this._schedulePersistActivities();
    }
    pauseActivity(id) {
    ...
    clearCompletedActivities() {
        ...
        this._state = Object.assign(Object.assign({}, this._state), { activities: this._state.activities
                .filter((a) => !removedSet.has(a.id))
                .map((a) => a.children && a.children.some((c) => removedSet.has(c))
                ? Object.assign(Object.assign({}, a), { children: a.children.filter((c) => !removedSet.has(c)) }) : a) });
        for (const id of removed)
            this._pausedActivities.delete(id);
        this._notify();
        this._schedulePersistActivities();
    }
    _schedulePersistActivities() {
        ...
        try {
            ...
            const surviving = parsed.filter((a) => {
                ...
                if (a.status === "running" || a.status === "pending") {
                    ...
                    a.status = "cancelled";
                    a.completedAt = (_a = a.completedAt) !== null && _a !== void 0 ? _a : new Date().toISOString();
                    a.error = (_b = a.error) !== null && _b !== void 0 ? _b : "Interrupted by reload";
                }
            ...
            for (const a of surviving) {
                if (a.children)
                    a.children = a.children.filter((c) => validIds.has(c));
                if (a.parentId && !validIds.has(a.parentId))
                    a.parentId = undefined;
            }
            this._state = Object.assign(Object.assign({}, this._state), { activities: surviving });
        }
        catch (_b) {
            // best-effort hydrate
        }
    ...
    setWorkflowState(patch) {
        this._state = Object.assign(Object.assign({}, this._state), { workflow: Object.assign(Object.assign({}, this._state.workflow), patch) });
        this._notify();
    }
    ...
    recordHistorySnapshot() {
        ...
        for (const info of s.accountInfos) {
            const slot = (_a = regionHealth.get(info.region)) !== null && _a !== void 0 ? _a : { healthy: 0, total: 0 };
            slot.total += 1;
        ...
        const snapshot = {
            ...
            failedNodes: s.nodes.filter((n) => n.state === "unusable" || n.state === "starttaskfailed").length,
            dedicatedCoresUsed: s.accountInfos.reduce((acc, a) => acc + a.dedicatedCoresUsed, 0),
            dedicatedCoresQuota: s.accountInfos.reduce((acc, a) => acc + a.dedicatedCoreQuota, 0),
            lpCoresUsed: s.accountInfos.reduce((acc, a) => acc + a.lowPriorityCoresUsed, 0),
            lpCoresQuota: s.accountInfos.reduce((acc, a) => acc + a.lowPriorityCoreQuota, 0),
            healthyRegions,
            unhealthyRegions,
        };
        ...
        this._state = Object.assign(Object.assign({}, this._state), { history: next });
        this._notify();
    }
    ...
    clearHistory() {
        if (this._state.history.length === 0)
            return;
        this._state = Object.assign(Object.assign({}, this._state), { history: [] });
        this._notify();
    }
    // --- User Preferences ---
    getUserPreferences() {
        try {
            ...
            return raw
                ? Object.assign(Object.assign({}, DEFAULT_USER_PREFERENCES), JSON.parse(raw)) : Object.assign({}, DEFAULT_USER_PREFERENCES);
        }
        catch (_a) {
            return Object.assign({}, DEFAULT_USER_PREFERENCES);
        }
    }
    saveUserPreferences(prefs) {
        const current = this.getUserPreferences();
        localStorage.setItem("multi-region-prefs", JSON.stringify(Object.assign(Object.assign({}, current), prefs)));
    }
    // --- Azure Accounts (multi-account auth) ---
    /** Set / replace all AzureLoginAccounts */
    setAzureAccounts(accounts) {
        this._state = Object.assign(Object.assign({}, this._state), { azureAccounts: [...accounts] });
        this._notify();
    }
    /** Upsert a single AzureLoginAccount (by homeAccountId) */
    upsertAzureAccount(account) {
        const existing = this._state.azureAccounts.findIndex((a) => a.homeAccountId === account.homeAccountId);
        let azureAccounts;
        if (existing >= 0) {
            azureAccounts = this._state.azureAccounts.map((a) => a.homeAccountId === account.homeAccountId ? account : a);
        }
        else {
            azureAccounts = [...this._state.azureAccounts, account];
        }
        this._state = Object.assign(Object.assign({}, this._state), { azureAccounts });
        this._notify();
    }
    /** Remove an AzureLoginAccount by homeAccountId */
    removeAzureAccount(homeAccountId) {
        this._state = Object.assign(Object.assign({}, this._state), { azureAccounts: this._state.azureAccounts.filter((a) => a.homeAccountId !== homeAccountId) });
        this._notify();
    }
    /** Patch a single AzureLoginAccount */
    updateAzureAccount(homeAccountId, patch) {
        this._state = Object.assign(Object.assign({}, this._state), { azureAccounts: this._state.azureAccounts.map((a) => a.homeAccountId === homeAccountId ? Object.assign(Object.assign({}, a), patch) : a) });
        this._notify();
    }
    // --- Tenants & Graph ---
    /**
     ...
     */
    setActiveTenant(homeAccountId, tenantId) {
        if (!homeAccountId || !tenantId)
            return;
        const activeTenants = Object.assign(Object.assign({}, this._state.activeTenants), { [homeAccountId]: tenantId });
        this._state = Object.assign(Object.assign({}, this._state), { activeTenants, azureAccounts: this._state.azureAccounts.map((a) => a.homeAccountId === homeAccountId
                ? Object.assign(Object.assign({}, a), { activeTenantId: tenantId }) : a) });
        try {
    ...
    setTenantUsers(tenantId, users) {
        if (!tenantId)
            return;
        this._state = Object.assign(Object.assign({}, this._state), { tenantUsers: Object.assign(Object.assign({}, this._state.tenantUsers), { [tenantId]: [...users] }) });
        this._notify();
    }
    addTenantUser(tenantId, user) {
        ...
        if (!tenantId)
            return;
        const existing = (_a = this._state.tenantUsers[tenantId]) !== null && _a !== void 0 ? _a : [];
        const idx = existing.findIndex((u) => u.id === user.id);
        const next = idx >= 0
            ? existing.map((u, i) => (i === idx ? user : u))
            : [...existing, user];
        this._state = Object.assign(Object.assign({}, this._state), { tenantUsers: Object.assign(Object.assign({}, this._state.tenantUsers), { [tenantId]: next }) });
        this._notify();
    }
    updateTenantUser(tenantId, userId, patch) {
        if (!tenantId || !userId)
            return;
        const existing = this._state.tenantUsers[tenantId];
        if (!existing)
            return;
        const next = existing.map((u) => u.id === userId ? Object.assign(Object.assign({}, u), patch) : u);
        this._state = Object.assign(Object.assign({}, this._state), { tenantUsers: Object.assign(Object.assign({}, this._state.tenantUsers), { [tenantId]: next }) });
        this._notify();
    }
    setPasswordResetCapability(homeAccountId, canReset) {
        if (!homeAccountId)
            return;
        this._state = Object.assign(Object.assign({}, this._state), { passwordResetCapability: Object.assign(Object.assign({}, this._state.passwordResetCapability), { [homeAccountId]: canReset }) });
        this._notify();
    }
    // --- Throttle Stats ---
    setThrottleStatusEntry(subscriptionId, family, entry) {
        ...
        this._state = Object.assign(Object.assign({}, this._state), { throttleStats: Object.assign(Object.assign({}, current), { perSubscription: Object.assign(Object.assign({}, current.perSubscription), { [key]: entry }) }) });
        this._notify();
    }
    pushThrottleTransition(transition) {
        const current = this._state.throttleStats;
        const history = [...current.history, transition].slice(-50);
        this._state = Object.assign(Object.assign({}, this._state), { throttleStats: Object.assign(Object.assign({}, current), { history }) });
        this._notify();
    }
    getThrottleStats() {
     ...
     */
    resetThrottleCircuit(subscriptionId, family) {
        const key = `${subscriptionId}::${family}`;
        const current = this._state.throttleStats;
        if (!current.perSubscription[key])
            return;
        const next = Object.assign({}, current.perSubscription);
        delete next[key];
        this._state = Object.assign(Object.assign({}, this._state), { throttleStats: Object.assign(Object.assign({}, current), { perSubscription: next }) });
        this._notify();
    }
    // --- Pool Defaults ---
    setPoolDefaults(defaults) {
        this._state = Object.assign(Object.assign({}, this._state), { poolDefaults: defaults });
        savePoolDefaults(defaults);
        this._notify();
    }
    updatePoolDefaults(patch) {
        const updated = Object.assign(Object.assign({}, this._state.poolDefaults), patch);
        this._state = Object.assign(Object.assign({}, this._state), { poolDefaults: updated });
        savePoolDefaults(updated);
        this._notify();
    }
    resetPoolDefaults() {
        const fresh = resetPoolDefaultsStorage();
        this._state = Object.assign(Object.assign({}, this._state), { poolDefaults: fresh });
        this._notify();
        return fresh;
    }
    loadPoolDefaultsFromStorage() {
        const loaded = loadPoolDefaults();
        this._state = Object.assign(Object.assign({}, this._state), { poolDefaults: loaded });
        this._notify();
    }
    // --- Export ---
    exportSessionAsJson() {
        const _a = this._state, { agentStatuses } = _a, rest = __rest(_a, ["agentStatuses"]);
    ...
    retryFailedAccounts() {
        const ids = this._state.accounts
            ...
            .map((a) => a.id);
        this._state = Object.assign(Object.assign({}, this._state), { accounts: this._state.accounts.map((a) => a.provisioningState === "failed"
                ? Object.assign(Object.assign({}, a), { provisioningState: "pending", error: null }) : a) });
        this._notify();
        return ids;
    }
    retryFailedPools() {
        const ids = this._state.pools
            ...
            .map((p) => p.id);
        this._state = Object.assign(Object.assign({}, this._state), { pools: this._state.pools.map((p) => p.provisioningState === "failed"
                ? Object.assign(Object.assign({}, p), { provisioningState: "pending", error: null }) : p) });
        this._notify();
        return ids;
    }
    // --- Bulk Reset ---
    ...
    saveSession() {
        ...
        const buildPayload = (logTailSize) => {
            const _a = this._state, { 
            ...
            activities, 
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            tenantUsers, agentLogs } = _a, rest = __rest(_a, ["notifications", "history", "activities", "tenantUsers", "agentLogs"]);
            return JSON.stringify(Object.assign(Object.assign({}, rest), { agentLogs: agentLogs.slice(-logTailSize), agentStatuses: Object.assign({}, DEFAULT_AGENT_STATUSES) }));
        };
        const isQuotaErr = (e) => {
            const msg = e instanceof Error ? e.message : String(e);
        ...
        for (let phase = 0; phase < evictionPlan.length; phase++) {
            ...
            try {
                ...
                const existing = index.findIndex((s) => s.id === this._state.sessionId);
                const entry = {
                ...
                while (index.length > keepSessions) {
                    ...
                    const evictIdx = index.findIndex((s) => s.id !== this._state.sessionId);
                    if (evictIdx < 0)
                        break;
                ...
                if (phase > 0) {
                    console.info(`[MultiRegionStore] saveSession recovered from quota error after eviction phase ${phase} (keepSessions=${keepSessions}, logTail=${logTail}).`);
                }
                return true;
            }
            catch (e) {
        ...
        console.warn(`[MultiRegionStore] saveSession failed${isQuota ? " (storage quota exceeded after eviction)" : ""}:`, msg);
        return false;
    }
    /**
    ...
    renameSession(name) {
        ...
        this._state = Object.assign(Object.assign({}, this._state), { sessionName: trimmed && trimmed.length > 0 ? trimmed : undefined });
        this._notify();
    }
    /**
    ...
    newSession(name) {
        const trimmed = name === null || name === void 0 ? void 0 : name.trim();
        this._state = Object.assign(Object.assign({}, createInitialState()), { sessionId: generateSessionId(), sessionName: trimmed && trimmed.length > 0 ? trimmed : undefined });
        this._notify();
    }
    /**
            ...
            timer = setTimeout(() => {
                ...
                if (ok) {
                    ...
                    if (consecutiveFailures === 1 || consecutiveFailures % 10 === 0) {
                        console.warn(`[MultiRegionStore] auto-save failed (${consecutiveFailures} consecutive). ` +
...
//# sourceMappingURL=multi-region-store.js.map