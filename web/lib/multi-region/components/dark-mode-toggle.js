...
export const DarkModeToggle = () => {
    ...
    const [theme, setTheme] = useBroadcastPref("batch-theme-mode", "dark");
    ...
    return (React.createElement(Tooltip, null,
        React.createElement(TooltipTrigger, { asChild: true },
            React.createElement(Button, { variant: "ghost", size: "icon-sm", "aria-label": label, "aria-pressed": isDark, onClick: handleToggle, className: cn(isDark ? "text-warning" : "text-primary") }, isDark ? React.createElement(Moon, null) : React.createElement(Sun, null))),
