 ...
 */
export const EMPTY_TEMPLATES_STATE = {
    templates: [],
};
/* ====================================================================== */
/* Helpers                                                                */
 ...
 */
export function upsertTemplate(prev, next) {
...
export function removeTemplate(prev, id) {
...
export function findTemplate(list, id) {
    var _a;
    return (_a = list.find((t) => t.id === id)) !== null && _a !== void 0 ? _a : null;
}
/**
 ...
 */
export function migrateTemplates(raw, _oldVersion) {
    ...
    if (raw &&
        ...
        return {
            templates: raw.templates.filter(isTemplateShape),
        };
    }
    return undefined;
}
function isTemplateShape(v) {
...
//# sourceMappingURL=cost-report-templates.js.map