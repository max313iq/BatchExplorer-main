 ...
 */
export function computeScopeFingerprint(sub) {
    var _a, _b, _c, _d;
    ...
    const parts = [
        (_a = sub.billingProfileDisplayName) !== null && _a !== void 0 ? _a : "",
        (_b = sub.invoiceSectionDisplayName) !== null && _b !== void 0 ? _b : "",
        (_c = sub.costCenter) !== null && _c !== void 0 ? _c : "",
        // include status because "Disabled" / "Deleted" is also a scope-y mutation
        (_d = sub.status) !== null && _d !== void 0 ? _d : "",
    ];
    return parts.join("|");
}
const STORAGE_VERSION = 1;
const STORAGE_PREFIX = "ea-billing-manager:scope-watcher:";
function storageKey(billingAccountName) {
    return `${STORAGE_PREFIX}${billingAccountName}`;
}
export function loadScopeSnapshot(billingAccountName) {
    if (typeof window === "undefined" || !billingAccountName)
        return null;
    try {
...
export function saveScopeSnapshot(billingAccountName, snapshot) {
    if (typeof window === "undefined" || !billingAccountName)
        return;
    try {
        const envelope = { v: STORAGE_VERSION, data: snapshot };
        window.localStorage.setItem(storageKey(billingAccountName), JSON.stringify(envelope));
    }
    catch (_a) {
        /* quota / permission errors are silently ignored */
    }
}
export function clearScopeSnapshot(billingAccountName) {
    if (typeof window === "undefined" || !billingAccountName)
        return;
    try {
 ...
 */
export function detectScopeChanges(currentSubs, prev) {
    var _a;
    const nowIso = new Date().toISOString();
    const changes = {};
    const nextFingerprints = {};
    const prevMap = (_a = prev === null || prev === void 0 ? void 0 : prev.fingerprints) !== null && _a !== void 0 ? _a : {};
...
export function decodeFingerprint(fp) {
    var _a, _b, _c, _d;
    if (!fp)
        return null;
    ...
    if (parts.length !== 4)
        return null;
    return {
        profileName: (_a = parts[0]) !== null && _a !== void 0 ? _a : "",
        sectionName: (_b = parts[1]) !== null && _b !== void 0 ? _b : "",
        costCenter: (_c = parts[2]) !== null && _c !== void 0 ? _c : "",
        status: (_d = parts[3]) !== null && _d !== void 0 ? _d : "",
    };
}
//# sourceMappingURL=billing-scope-watcher.js.map