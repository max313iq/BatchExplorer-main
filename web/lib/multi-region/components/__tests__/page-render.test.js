...
jest.mock("@azure/bonito-ui/lib/components", () => ({
    MonacoEditor: () => null,
}), { virtual: true });
...
function renderAt(path) {
    ...
    const { OrchestratorAgent } = jest.requireMock("../../agents/orchestrator-agent");
    const orchestrator = new OrchestratorAgent({});
    const store = new MultiRegionStore();
    render(React.createElement(MemoryRouter, { initialEntries: [path] },
        React.createElement(MultiRegionStoreProvider, { store: store },
 ...
 */
function expectHeading(pattern) {
...
//# sourceMappingURL=page-render.test.js.map