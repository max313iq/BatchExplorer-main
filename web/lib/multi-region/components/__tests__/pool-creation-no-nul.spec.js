...
const POOL_CREATION_PATH = path.resolve(__dirname, "..", "pool-creation", "pool-creation-page.tsx");
describe("pool-creation-page.tsx integrity", () => {
    it("contains no NUL bytes", () => {
        ...
        if (positions.length > 0) {
            throw new Error(`pool-creation-page.tsx contains ${positions.length} NUL byte(s) at offsets ${positions.slice(0, 10).join(", ")}${positions.length > 10 ? "..." : ""}. Use a hex viewer to locate and strip them.`);
        }
...
//# sourceMappingURL=pool-creation-no-nul.spec.js.map