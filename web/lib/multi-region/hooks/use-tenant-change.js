...
import { TENANT_CHANGED_EVENT, } from "./tenant-changed-event";
export function useTenantChange(forAccountId, onChange) {
    ...
    React.useEffect(() => {
        const handler = (e) => {
            ...
            if (!detail)
                return;
            if (forAccountId && detail.homeAccountId !== forAccountId)
                return;
...
//# sourceMappingURL=use-tenant-change.js.map