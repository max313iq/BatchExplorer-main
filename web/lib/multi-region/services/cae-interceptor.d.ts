 ...
 */
export declare function parseCaeChallenge(wwwAuthHeader: string): string | null;
/**
 ...
 * unchanged.
 */
export declare function withCaeRecovery<T>(fn: (token: string) => Promise<T>, opts: WithCaeRecoveryOptions): Promise<T>;
/**
 ...
 */
export declare function buildCaeChallengeError(response: Response, fallbackMessage?: string): CaeChallengeError | null;
//# sourceMappingURL=cae-interceptor.d.ts.map