 ...
 */
export function wireAuditLoggers(authSetter, agentsSetter) {
    authSetter(getAuditLoggerForAuth());
    agentsSetter(getAuditLoggerForAgents());
}
//# sourceMappingURL=audit-wiring.js.map