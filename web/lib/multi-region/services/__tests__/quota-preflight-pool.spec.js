...
const mockedFetchAll = fetchAllPages;
 ...
 */
function queuePages(...rowsPerCall) {
    for (const rows of rowsPerCall) {
        mockedFetchAll.mockImplementationOnce((opts) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = opts === null || opts === void 0 ? void 0 : opts.onPage) === null || _a === void 0 ? void 0 : _a.call(opts, rows, rows, false);
            return rows;
        }));
    }
}
describe("checkPoolCreatable", () => {
    ...
    it("rejects when VM is not on Batch's supported list", () => __awaiter(void 0, void 0, void 0, function* () {
        queuePages([], []);
        const result = yield checkPoolCreatable({ subscriptionId: SUB_ID }, "eastus", "Standard_NC24s_v3", 8, "tok");
        expect(result.ok).toBe(false);
        expect(result.reason).toMatch(/Batch does not support/i);
    }));
    it("rejects when the VM is restricted at subscription scope", () => __awaiter(void 0, void 0, void 0, function* () {
        queuePages(
    ...
    it("accepts on happy path", () => __awaiter(void 0, void 0, void 0, function* () {
        queuePages([{ name: "Standard_D2_v3", familyName: "dv3" }], [
            {
                name: "Standard_D2_v3",
                resourceType: "virtualMachines",
        ...
        const result = yield checkPoolCreatable({ subscriptionId: SUB_ID }, "eastus", "Standard_D2_v3", 4, "tok");
        expect(result.ok).toBe(true);
        expect(result.reason).toBeUndefined();
    }));
    it("fails open when both probes throw", () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=quota-preflight-pool.spec.js.map