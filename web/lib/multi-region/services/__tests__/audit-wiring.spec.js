 ...
 */
import { wireAuditLoggers, getAuditLoggerForAuth, getAuditLoggerForAgents, } from "../audit-wiring";
...
describe("audit-wiring", () => {
    ...
    it("wireAuditLoggers invokes both setters", () => {
        ...
        const authArg = authSetter.mock.calls[0][0];
        const agentsArg = agentsSetter.mock.calls[0][0];
...
//# sourceMappingURL=audit-wiring.spec.js.map